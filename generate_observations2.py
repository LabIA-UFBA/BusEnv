...
OUTPUT_PATH = "./output_obs2"
GRAPH_PATH = "./SUNT/data/graph_designer/graph_gtfs_fev_2024.gpickle"
...
# === Advanced Finalization with Statistics ===
def finalize_enhanced_dict(d, remove_outliers=True):
    """Calculate robust averages with outlier removal and statistics"""
    result = {}
    stats = {}
    ...
    for k, values in d.items():
        ...
        if remove_outliers and len(values) > 3:
            ...
            if len(clean_values) == 0:
                clean_values = values  # Fallback if all values were considered outliers
        else:
            clean_values = values
